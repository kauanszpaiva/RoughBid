...
const serverOnlyKeys = ['SUPABASE_SERVICE_ROLE_KEY', 'SUPABASE_SECRET_KEY', 'STRIPE_SECRET_KEY', 'RESEND_API_KEY', 'GEMINI_API_KEY', 'OPENROUTER_API_KEY', 'OPENAI_API_KEY', 'BLOB_READ_WRITE_TOKEN'];
