...
export class VercelBlobObjectStorage {
  ...
  async presign(method: PresignedObjectRequest['method'], key: string, options: { expiresIn?: number; contentType?: string; downloadName?: string } = {}): Promise<PresignedObjectRequest> {
