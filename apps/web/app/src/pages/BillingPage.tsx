    ...
    {user?.isAdmGod && (
      <section className="rounded-xl bg-amber-50 border border-amber-300 p-5 text-amber-950">
        <h2 className="font-bold flex items-center gap-2">
          <span>Platform Owner Identity Verified (ADM GOD)</span>
        </h2>
        <p className="text-sm mt-1">
          RoughBid subscriptions and paywalls are bypassed for this account. Free owner AI plan readings require the dedicated free-tier provider route and SQL migrations to be enabled on the backend.
        </p>
      </section>
    )}
